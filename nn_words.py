...
4. create a structure where output is yielded but randomly some words are skipped to create unrecognizable patterns in output.
'''

def find_knn(tfidf_file_name,input_word,k=10):
    ...
    k : amount of nearest neighbors to yield.(default=10)

    @yields:
    word : kth Nearnest Neighbor of the provided input_word for specified file.
    '''
